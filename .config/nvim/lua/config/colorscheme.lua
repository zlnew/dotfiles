local function apply()
  ...
  set(0, "LineNr", { fg = c.text_faint })
  set(0, "CursorLineNr", { fg = c.fg_secondary, bold = true })
  set(0, "CursorLine", { bg = "NONE" })
  set(0, "CursorColumn", { bg = c.bg_primary })
  set(0, "ColorColumn", { bg = c.bg_primary })
  ...
  set(0, "Pmenu", { fg = c.fg_primary, bg = c.bg_secondary })
  ...
  set(0, "LazyButton", { fg = c.fg_primary, bg = c.bg_secondary })
  set(0, "LazyButtonActive", { fg = c.bg_primary, bg = c.info, bold = true })
  ...
  -- NOICE
  -- =========================================================
  set(0, "NoiceCmdlinePopup", { fg = c.fg_primary, bg = c.bg_secondary })
  set(0, "NoiceCmdlinePopupBorder", { fg = c.text_faint, bg = c.bg_secondary })
  set(0, "NoiceCmdlineIcon", { fg = c.info })
  set(0, "NoiceConfirm", { fg = c.fg_primary, bg = c.bg_secondary })
  set(0, "NoiceConfirmBorder", { fg = c.text_faint, bg = c.bg_secondary })
