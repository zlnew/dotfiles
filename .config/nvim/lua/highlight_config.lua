...
function M.setup(colors)
  ...
  set(0, "CursorLineNr", { fg = colors.fg_secondary, bg = colors.bg_tertiary, bold = true })
  ...
  set(0, "FloatTitle", { fg = colors.accent_tertiary, bg = colors.bg_primary, bold = true })
  set(0, "FloatFooter", { fg = colors.text_faint, bg = colors.bg_primary })
