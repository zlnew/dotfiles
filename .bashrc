...
alias dragon_fresh='php artisan migrate:fresh --seed; php artisan db:seed --class=UserSeeder; php artisan db:seed --class=BrandSeeder; php artisan db:seed --class=ApprovalConfigurationSeeder'
...
export PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/home/zlnew/.config/composer/vendor/bin
